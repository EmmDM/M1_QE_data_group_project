...
graph_decoupling_final_convert <- ggplot(decoupling_final_convert, aes(x = taux_PIB_90_20,y = taux_GES_90_20)) + geom_point( size=1, na.rm = TRUE)  +  labs(title = "Découplage au sein de l'OCDE", x = "Taux de croissance du PIB/hab \n en 2020 par rapport à 1990 (%)", y = "Taux de croissance des émissions de GES \n en 2020 par rapport à 1990 (%)") + theme_minimal()  +  geom_abline(intercept = 0, slope = 1, color = "black") + geom_abline(intercept = 0, slope = 0, color = "black") + geom_abline(intercept = 0, slope = 0, color = "black") + geom_vline(xintercept = 0, color = "black") 
...
x_limits <- c(-70,1000)
y_limits <- c(-75,1000)
graph_decoupling_non_OCDE <- ggplot(decoupling_final_convert_non_OCDE, aes(x = taux_PIB_90_20,y = taux_GES_90_20)) + geom_point( size=1, na.rm = TRUE)  +  labs(title = "Découplage des pays non membres de l'OCDE", x = "Taux de croissance du PIB/hab \n en 2020 par rapport à 1990 (%)", y = "Taux de croissance des émissions de GES en 2020 \n par rapport à 1990 (%)") + theme_minimal() + coord_cartesian(xlim = x_limits, ylim = y_limits)  + geom_abline(intercept = 0, slope = 1, color = "black") + geom_abline(intercept = 0, slope = 0, color = "black") + geom_abline(intercept = 0, slope = 0, color = "black") + geom_vline(xintercept = 0, color = "black")


(graph_decoupling_final_convert  | graph_decoupling_non_OCDE ) + plot_annotation(title = "Comparaison entre les groupes OCDE et non-OCDE")
```
